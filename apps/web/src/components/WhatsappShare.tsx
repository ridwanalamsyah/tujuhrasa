...
export function WhatsappShare({
  ...
  return (
    <button
      onClick={onClick}
      className={
        "inline-flex items-center gap-2 rounded-sm border-2 border-[var(--tr-ink)] bg-[var(--tr-leaf)]/15 text-[var(--tr-ink)] px-3 py-1.5 text-[10px] font-mono uppercase tracking-widest hover:bg-[var(--tr-leaf)] hover:text-[var(--tr-paper)] transition " +
        className
      }
      aria-label={label}
    >
